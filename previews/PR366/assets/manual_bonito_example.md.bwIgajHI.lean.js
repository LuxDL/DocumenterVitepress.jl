...
<\/script><div data-jscall-id="2"><button onclick="" class=" style_2 style_3 style_4" style="" data-jscall-id="3">Click me&#33;</button><p data-jscall-id="4">Clicks: <span data-jscall-id="1">0</span></p></div></div></div></div>`};function b(u,s,E,y,m,f){const i=n("ClientOnly"),t=e("exec-scripts");return o(),l("div",null,[s[0]||(s[0]=p("",8)),d(i,null,{default:r(()=>[h(c("div",g,null,512),[[t]])]),_:1})])}const F=a(k,[["render",b]]);export{x as __pageData,F as default};
