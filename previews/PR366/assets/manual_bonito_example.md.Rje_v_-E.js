import{_ as t,C as n,ap as e,o as l,c as p,al as h,E as o,w as k,a2 as r,j as d}from"./chunks/framework.DWI0wQKr.js";const C=JSON.parse('{"title":"Bonito interactivity","description":"","frontmatter":{},"headers":[],"relativePath":"manual/bonito_example.md","filePath":"manual/bonito_example.md","lastUpdated":null}'),c={name:"manual/bonito_example.md"},g={class:"vp-raw-html",innerHTML:`<div><div data-jscall-id="root" id="cd37a7f5-a543-4d02-bfea-795e28daa510" class="bonito-fragment" style="display:contents"><div style="display:contents"><script src="/DocumenterVitepress.jl/previews/PR366/bonito/js/Bonito.bundled5040008371911548254.js" type="module"><\/script><style></style><style>@media (prefers-color-scheme: light) {
  :root {
...
</style></div><div style="display:contents"><script type="module">Bonito.init_session("cd37a7f5-a543-4d02-bfea-795e28daa510", Bonito.fetch_binary('/DocumenterVitepress.jl/previews/PR366/bonito/bin/f04f961b81ca5054681da228cbcefa8a0ca44eed-11963620713763406911.bin'), "root", false);
<\/script><div></div></div></div><div data-jscall-id="subsession-application-dom" id="8b1d7f27-53ce-423f-8a71-ec0aca68b1ff" class="bonito-fragment" style="display:contents"><div style="display:contents"><style>.style_2 {
  font-weight: 600;
...
</style></div><div style="display:contents"><script type="module">Bonito.init_session("8b1d7f27-53ce-423f-8a71-ec0aca68b1ff", Bonito.fetch_binary('/DocumenterVitepress.jl/previews/PR366/bonito/bin/5981cfe1c8daea805cd81a6cd13175bc808821dc-11790479609218406007.bin'), "sub", false);
<\/script><div data-jscall-id="2"><button data-jscall-id="3" class=" style_2 style_3 style_4" onclick="" style="">Click me&#33;</button><p data-jscall-id="4">Clicks: <span data-jscall-id="1">0</span></p></div></div></div></div>`};function E(y,i,b,u,F,f){const s=n("ClientOnly"),a=e("exec-scripts");return l(),p("div",null,[i[0]||(i[0]=h(`<h1 id="Bonito-interactivity" tabindex="-1">Bonito interactivity <a class="header-anchor" href="#Bonito-interactivity" aria-label="Permalink to &quot;Bonito interactivity {#Bonito-interactivity}&quot;">​</a></h1><p><a href="https://github.com/SimonDanisch/Bonito.jl" target="_blank" rel="noreferrer">Bonito.jl</a> renders interactive apps and widgets (it also powers WGLMakie figures) as <code>text/html</code> output. DocumenterVitepress executes the <code>&lt;script&gt;</code> tags such output contains on the client, both on first load and after client-side navigation, so Bonito apps work without a hard page reload.</p><p>Add <code>DocumenterVitepress.BonitoPlugin()</code> to <code>makedocs(plugins = [...])</code> to have Bonito&#39;s JS/CSS bundle shipped once through the site&#39;s <code>public/</code> folder instead of being re-embedded inline on every figure. <code>Page()</code> still goes at the top of the page exactly as <a href="https://github.com/SimonDanisch/Bonito.jl/blob/master/docs/src/deployment.md#documenter" target="_blank" rel="noreferrer">Bonito&#39;s own docs</a> describe; nothing else about writing a Bonito app changes.</p><p>A counter that keeps working after the page is exported to static HTML: the click handler updates the counter&#39;s own DOM node directly in JavaScript, so no running Julia session is needed once deployed (see Bonito&#39;s <a href="https://github.com/SimonDanisch/Bonito.jl/blob/master/docs/src/interactions.md#creating-interactive-examples" target="_blank" rel="noreferrer">static-export notes</a>).</p><p><strong>Input</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Bonito</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Page</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p><strong>Output</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">App</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">do</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> session</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    count </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DOM</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">span</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;0&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    button </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Button</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;Click me!&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    onjs</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(session, button</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">value, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">js</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;&quot;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">        function</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">clicked</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) {</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">        &quot;&quot;&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DOM</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">div</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(button, DOM</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">p</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;Clicks: &quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, count))</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div>`,8)),o(s,null,{default:k(()=>[r(d("div",g,null,512),[[a]])]),_:1})])}const v=t(c,[["render",E]]);export{C as __pageData,v as default};
